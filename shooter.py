...
display.set_icon(image.load('asteroid.png'))
...
# шрифти і написи
font.init()
font1 = font.Font("Tiny5-Regular.ttf", 80)
font2 = font.Font("Tiny5-Regular.ttf", 36)
win = font1.render('YOU WIN!', True, (255, 255, 255))
lose = font1.render('YOU LOSE!', True, (180, 0, 0))

# нам потрібні такі картинки:
img_back = "galaxy.png"  # фон гри
...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet("bullet1.png", self.rect.centerx, self.rect.top, 15, 20, -15)
        bullets.add(bullet)
